...
class gtfs_feed:    
   ...
   # setters     
    ...
    def frequence_par_shapes(self, date_demandee,
                            plage_horaire,
                            stop_sequence = 1):
        """
        ...
        Parameters
        ----------
        date_demandee : str "YYYYMMDD", mandatory
        plage_horaire : list() : [7, 9], mandatory
    ...
    def evol_journaliere(self, date_demandee):
        ...
        Parameters
        ----------
        date_demandee : str au format "YYYYMMDD"
            DESCRIPTION.
    ...
    def evol_journaliere_ligne(self, date_demandee, ligne):
        ...
        ----------
        date_demandee : str au format "YYYYMMDD"
        ligne : list() de lignes. pour une ligne écrire sour la forme : ['ligne']
            DESCRIPTION.
    ...
    def plot_evol_journaliere(self, date_demandee, titre = "Evolution journalière",
        ...
        Parameters
        ----------
        date_demandee : str au format "YYYMMDD"
            DESCRIPTION.
        titre : str, optional
            DESCRIPTION. The default is "Evolution journalière".
        x_axe : str, optional
            DESCRIPTION. The default is None.
        y_axe_1 : str, optional
            DESCRIPTION. The default is "évol. ens. des lignes [nombre]".
        liste_ligne_a_tracer : str, optional
            DESCRIPTION. The default is None.
        y_axe_2 : str, optional
            DESCRIPTION. The default is "évol. lignes spécif. [nombre]".
    ...
    def freq_min(self, date_demandee, plage_horaire = [7,21], stop_sequence = 8):
        ...
        date_demandee : TYPE
            DESCRIPTION.
        plage_horaire : TYPE, optional
            DESCRIPTION. The default is [7,21].
        stop_sequence : TYPE, optional
...
########## getters  
    ...
    def _get_freq_min(self, date_demandee,
        ...
        # coef = plage_horaire[1] - plage_horaire[0] # a supprimer
        # trips_stops_["freq"] = coef * 60 / trips_stops_['count'] # a supprimer
    ...
    def _get_frequence_par_ligne(self, date_demandee,plage_horaire, stop_sequence):
        ...
        liste_service_except = self._get_services_exceptions(date_demandee)
        # 1calendar_dates[calendar_dates['date']\
