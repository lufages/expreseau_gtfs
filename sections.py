...
class sections:
    ...
    def _get_list_section(self, departs, arrivees):
        ...
        if list_troncons == None:
            ...
            # print(noeud_separation, arrivees)
            # print(noeud_separation)
    ...
    def _get_trc_par_frequence(self, seg, coef = 1.3):
        ...
        list_nb_trips.append(seg[seg.segment == seg.segment.iloc[0]].trip_id.values[0])
        
        for n, m in zip(seg.segment[:-1],
                        seg.segment[1:]):
            t1 = seg[seg.segment == n].trip_id.values[0]
            t2 = seg[seg.segment == m].trip_id.values[0]
